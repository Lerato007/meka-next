...
export default function ShippedEmail({
  ...
  const previewText = `Your order ${order.orderNumber} has been shipped`
...
<Text style={paragraph}>
  It is now on its way to your delivery address. You can
  use the button below to view your order at any time.
</Text>

<Text style={paragraph}>
  We'll send you another email as soon as your order has
  been delivered.
</Text>
