...
export default function DeliveredEmail({
  ...
  const previewText = `Your order ${order.orderNumber} has been delivered`
...
<Text style={paragraph}>
  We hope everything arrived safely and that you're happy with your purchase.
</Text>

<Text style={paragraph}>
  Thank you for choosing MekaWC. We truly appreciate your support and hope to see you again soon.
</Text>
