    ...
    Apply
        ...
        {products.length === 0 ? (
          <div className="card group overflow-hidden transition hover:-translate-y-1 hover:shadow-lg">
            ...
            <Link
              href="/products"
              className="mt-6 inline-flex rounded-lg bg-gray-950 px-5 py-2.5 text-sm font-semibold text-white hover:bg-gray-800"
            >
              View all products
            </Link>
          </div>
              ...
              >
                {currentPage > 1 && (
                  <Link
                    ...
                    className="rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 transition hover:border-gray-950"
                  >
                    ← Previous
                  </Link>
                )}
